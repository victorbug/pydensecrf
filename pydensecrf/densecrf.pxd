...
cdef extern from "densecrf/include/densecrf.h":
    cdef cppclass c_DenseCRF2D "DenseCRF2D" (c_DenseCRF):
        ...
        void addPairwiseGaussian(const unsigned char *npykerx, const unsigned char *npykery, float sx, float sy, LabelCompatibility*, KernelType, NormalizationType)
        void addPairwiseBilateral(const unsigned char *npykerx, const unsigned char *npykery, float sx, float sy, float sr, float sg, float sb, const unsigned char *rgbim, LabelCompatibility*, KernelType, NormalizationType)
